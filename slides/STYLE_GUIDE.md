...
| 용도 | 클래스 | 색 |
|------|--------|----|
| 배경 (카드) | `bg-gray-900` | 어두운 회색 |
| 강조 배경 | `bg-blue-950/30` | 반투명 파란색 |
| 성공/긍정 | `bg-green-950/40` | 반투명 초록 |
| 경고/주의 | `bg-orange-950/30` | 반투명 주황 |
| 에러/전 | `bg-red-950/30` | 반투명 빨강 |
| 보더 강조 | `border-blue-400` | 파란 테두리 |
| 텍스트 강조 | `text-blue-300` | 밝은 파란 텍스트 |
