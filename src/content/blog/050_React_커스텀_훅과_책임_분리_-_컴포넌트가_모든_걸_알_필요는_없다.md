...
<!--
  📸 이미지 프롬프트:
  prompt: "flat illustration of a React component with too many responsibilities, showing state management, validation, API calls all tangled together inside one box, messy wires and connections, developer looking stressed, modern tech illustration style, blue and white color scheme"
  aspect_ratio: "16:9"
  session_id: "blog-050"
  save_as: "050_01_tangled-component.png"
-->
...
<!--
  📸 이미지 프롬프트:
  prompt: "flat illustration showing clean separation between a React component (UI layer, showing form elements) and a custom hook (logic layer, showing state and API calls), two distinct boxes connected by arrows, clean and organized, modern tech diagram style, blue and green color scheme"
  aspect_ratio: "16:9"
  session_id: "blog-050"
  save_as: "050_02_separated-structure.png"
-->
...
<!--
  📸 이미지 프롬프트:
  prompt: "flat illustration of hook composition pattern, showing small lego-like building blocks labeled useInput, useValidation, useSubmit being assembled together into a larger useSignupForm hook, colorful modular blocks fitting together, clean tech illustration style"
  aspect_ratio: "16:9"
  session_id: "blog-050"
  save_as: "050_03_hook-composition.png"
-->
