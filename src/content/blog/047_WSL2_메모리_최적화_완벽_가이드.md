...
featured_image: /images/blogs/047/047_00_thumbnail.png
featured_image_alt: "WSL2 메모리 최적화로 vmmem 프로세스 줄이기"
category: DevOps
...
<!-- 📸 이미지 프롬프트: prompt: "Windows Task Manager showing vmmem process consuming 15.9GB RAM, system nearly frozen, dramatic red warning colors, then after optimization showing healthy 6GB usage in green, before-and-after split screen, flat illustration style", aspect_ratio: "16:9", session_id: "blog-047", save_as: "047_00_thumbnail.png" -->

![WSL2 메모리 최적화 전후 Task Manager 비교](/images/blogs/047/047_00_thumbnail.png)

## 프롤로그: 15.9GB를 찍고 뻗어버린 날

AI 코딩 도구(Antigravity)를 3개 동시에 돌리면서 빌드까지 트리거했더니, vmmem 프로세스가 **15.9GB**를 잡아먹고 컴퓨터 전체가 뻗어버렸습니다. 팬 소음은 비행기 이륙 수준, 마우스 커서는 1초에 한 번 깜빡...
...
<!-- 📸 이미지 프롬프트: prompt: "Diagram showing .wslconfig file settings with memory=12GB and autoMemoryReclaim=dropCache highlighted, arrows showing memory being returned from WSL2 to Windows, clean technical diagram, flat illustration, blue and white color palette", aspect_ratio: "16:9", session_id: "blog-047", save_as: "047_01_wslconfig-settings.png" -->

![WSL2 .wslconfig 설정 및 메모리 반환 구조](/images/blogs/047/047_01_wslconfig-settings.png)
...
<!-- 📸 이미지 프롬프트: prompt: "Before and after optimization table comparison showing WSL2 memory metrics, left side red with high numbers, right side green with optimized values, fan noise icon reduced, clean infographic data visualization, flat design", aspect_ratio: "16:9", session_id: "blog-047", save_as: "047_02_before-after.png" -->

![WSL2 메모리 최적화 전후 성능 데이터 비교](/images/blogs/047/047_02_before-after.png)
