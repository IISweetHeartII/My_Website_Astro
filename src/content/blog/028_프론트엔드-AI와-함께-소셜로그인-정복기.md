...
featured_image: /images/blogs/028/028_00_thumbnail.png
...
<!-- 📸 이미지 프롬프트: prompt: "Frontend developer using Cursor AI to analyze backend OAuth code, split screen showing Kakao login button on the left and backend code analysis on the right", aspect_ratio: "16:9", session_id: "blog-028", save_as: "028_00_thumbnail.png" -->
...
<!-- 📸 이미지 프롬프트: prompt: "OAuth 2.0 authorization flow diagram showing frontend, backend, and Kakao auth server with arrows indicating redirect flow, clean sequence diagram", aspect_ratio: "16:9", session_id: "blog-028", save_as: "028_01_oauth-flow.png" -->
...
<!-- 📸 이미지 프롬프트: prompt: "React Next.js code showing Kakao login button with yellow background and anchor tag, alongside session check hook code in TypeScript", aspect_ratio: "16:9", session_id: "blog-028", save_as: "028_02_kakao-login-code.png" -->
