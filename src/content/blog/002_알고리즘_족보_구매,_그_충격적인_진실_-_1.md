...
category: 일상
featured_image: /images/blogs/002/002_00_thumbnail.png
...
<!-- 📸 이미지 프롬프트: prompt: "A stressed college student staring at a laptop screen with panic, online community message board visible on screen, dramatic lighting, webtoon illustration style", aspect_ratio: "16:9", session_id: "blog-002", save_as: "002_00_thumbnail.png" -->

다가오는 월요일은 알고리즘 시험일. 절박한 마음으로 대학생 커뮤니티 '에브리타임'에서 족보를 구하기 시작했습니다.
![에브리타임에서 족보 판매 글을 확인하는 장면](/images/blogs/002/002_01_market-post.png)

'판매한다'는 게시글에 홀린 듯 쪽지를 보냈고, 의심 없이 구매 절차를 진행했습니다. 하지만 족보를 사는 길은 생각보다 험난했습니다.
![송금 직전 불안한 마음으로 결제하는 장면](/images/blogs/002/002_02_transfer-moment.png)
...
![구매한 자료가 가짜에 가깝다는 사실을 깨닫는 장면](/images/blogs/002/002_03_shocking-discovery.png)
![복붙 자료와 조악한 문서 조합을 확인하는 장면](/images/blogs/002/002_04_fake-documents.png)

이런 것을 2만 원에 팔 수 있다니... 어처구니가 없었습니다.

<!-- 📸 이미지 프롬프트: prompt: "A shocked college student discovering fake documents on their laptop, expression of disbelief and frustration, comic style illustration", aspect_ratio: "16:9", session_id: "blog-002", save_as: "002_01_shocking-discovery.png" -->
...
![환불을 요구하는 메시지를 단호하게 보내는 장면](/images/blogs/002/002_05_refund-request.png)

<!-- 📸 이미지 프롬프트: prompt: "A person typing a firm refund request message on a smartphone chat app, determined expression, clean flat illustration style", aspect_ratio: "16:9", session_id: "blog-002", save_as: "002_02_refund-request.png" -->
