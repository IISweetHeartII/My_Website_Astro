...
category: 생산성
featured_image: /images/blogs/020/020_00_thumbnail.png
...
<!-- 📸 이미지 프롬프트: prompt: "A futuristic developer workflow visualization showing five interconnected MCP server tools with AI brain in the center, automated pipelines flowing between tools like Playwright, Context7, Magic, Task Master and Sequential Thinking, dark tech aesthetic with glowing connections", aspect_ratio: "16:9", session_id: "blog-020", save_as: "020_00_thumbnail.png" -->
...
<!-- 📸 이미지 프롬프트: prompt: "Playwright browser automation test running in a terminal alongside a visible Chrome browser window showing automated login test steps executing in real-time, developer environment screenshot style", aspect_ratio: "16:9", session_id: "blog-020", save_as: "020_01_playwright-automation.png" -->
...
<!-- 📸 이미지 프롬프트: prompt: "A project management dashboard showing Task Master AI interface with task list, priority levels, dependency graph and progress tracking, modern productivity tool UI design, clean and minimal", aspect_ratio: "16:9", session_id: "blog-020", save_as: "020_02_taskmaster-dashboard.png" -->
