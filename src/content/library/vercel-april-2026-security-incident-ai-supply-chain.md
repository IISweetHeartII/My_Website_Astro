...
<!--
  📸 이미지 프롬프트:
  prompt: "Cybersecurity editorial illustration showing a cloud deployment platform under alert, OAuth app chain, AI tool supply chain compromise, environment variables and secrets boundary, minimal flat tech style, blue red security palette"
  aspect_ratio: "4:3"
...
<!--
  📸 이미지 프롬프트:
  prompt: "Flowchart illustration of an AI tool OAuth compromise leading to Google Workspace account takeover, then internal cloud environment access and environment variable exposure, clean flat infographic style"
  aspect_ratio: "16:9"
  session_id: "library-vercel-april-2026-security-incident-ai-supply-chain"
  save_as: "01_oauth-supply-chain-path.png"
-->
...
<!--
  📸 이미지 프롬프트:
  prompt: "Security comparison graphic showing sensitive versus non-sensitive environment variables, one side encrypted and protected, the other side exposed and enumerable, minimal product security infographic"
  aspect_ratio: "16:9"
  session_id: "library-vercel-april-2026-security-incident-ai-supply-chain"
  save_as: "02_sensitive-env-boundary.png"
-->
...
<!--
  📸 이미지 프롬프트:
  prompt: "Editorial cybersecurity diagram showing developer productivity stack as an attack surface, Google Workspace, AI tools, cloud deployment, source control and secrets management connected, modern flat illustration"
  aspect_ratio: "16:9"
  session_id: "library-vercel-april-2026-security-incident-ai-supply-chain"
  save_as: "03_productivity-stack-attack-surface.png"
-->
