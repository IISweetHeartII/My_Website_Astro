...
## 참고 자료
- [GitHub Copilot how-to-write-a-great-agents-md lessons from over 2500 repositories](https://github.blog/ai-and-ml/github-copilot/how-to-write-a-great-agents-md-lessons-from-over-2500-repositories/)
- [OpenAI Codex: agents.md 가이드](https://developers.openai.com/codex/guides/agents-md)
