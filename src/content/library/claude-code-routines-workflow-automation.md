...
![프롬프트가 루틴 자산으로 바뀌는 실행 구조](/images/library/claude-code-routines-workflow-automation/01-routine-execution-surface.png)
...
<!--
  ...
  aspect_ratio: "16:9"
  session_id: "library-claude-code-routines-workflow-automation"
  save_as: "01-routine-execution-surface.png"
-->
...
![정적 자동화와 루틴형 자동화의 차이](/images/library/claude-code-routines-workflow-automation/02-trigger-model-comparison.png)
...
<!--
  ...
  aspect_ratio: "16:9"
  session_id: "library-claude-code-routines-workflow-automation"
  save_as: "02-trigger-model-comparison.png"
-->
...
![한국 개발팀의 루틴 도입 체크리스트](/images/library/claude-code-routines-workflow-automation/03-korean-dev-checklist.png)
