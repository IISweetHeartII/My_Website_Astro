...
reading_time: 9
featured_image: /images/library/claude-code-codex-sandbox-governance-2026/thumbnail.png
featured_image_alt: "Claude Code와 Codex 같은 코딩 에이전트가 샌드박스 안에서 권한, 메모리, 로그 경계로 분리되어 실행되는 모습"
