...
<!--
  📸 이미지 프롬프트:
  prompt: "Editorial tech illustration of an open source repository being locked while an AI system scans blueprints and code, dramatic but clean, blue steel and amber palette, flat illustration, magazine style"
  aspect_ratio: "4:3"
  session_id: "library-calcom-open-to-closed-source-ai-security"
...
<!--
  📸 이미지 프롬프트:
  prompt: "Concept illustration of AI scanning open source repositories for vulnerabilities, blueprint overlays, exploit graph, defenders vs attackers asymmetry, clean editorial vector style, 16:9"
  aspect_ratio: "16:9"
  session_id: "library-calcom-open-to-closed-source-ai-security"
  save_as: "01-ai-threat-model.png"
-->
...
<!--
  📸 이미지 프롬프트:
  prompt: "Editorial split-screen illustration of developer community debate over open source going closed source, one side realism, the other betrayal, forum threads and code repo imagery, flat modern style, 16:9"
  aspect_ratio: "16:9"
  session_id: "library-calcom-open-to-closed-source-ai-security"
  save_as: "02-community-reaction.png"
-->
...
<!--
  📸 이미지 프롬프트:
  prompt: "Korean engineering team reviewing open source license change risk, fallback options, self-hosting impact, security governance checklist, clean editorial infographic, flat illustration, 16:9"
  aspect_ratio: "16:9"
  session_id: "library-calcom-open-to-closed-source-ai-security"
  save_as: "03-korean-response-checklist.png"
-->
